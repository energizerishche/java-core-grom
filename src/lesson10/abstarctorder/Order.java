...
public abstract class Order {
    ...
    public boolean inArray(String requestedString, String[] variants) {
        if (requestedString != null && variants != null) {
            for (String variant : variants) {
                if (variant != null && variant.equals(requestedString)) {
                    return true;
                }
            }
        }
